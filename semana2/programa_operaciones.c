  ...
  
{
   ...
   printf("vamos a realizar algunas operaciones. Tendras que introducir 4 valores\n");
   ...
   printf("ahora realizaremos la sigiente operación: e=(a+b)*c/d\n");
     resultado1=(a+b)*c/d;
   printf("el resultado es %i", resultado1);
   ...
   printf("ahora realizaremos la sigiente operación: e=(a+b)*c/d\n");
     resultado3=(a+b)*c/d;
   printf("el resultado es %i", resultado3);

   printf("ahora realizaremos la sigiente operación: e=a+(b+c)/d\n");
     resultado4=a+(b+c)/d;
   printf("el resultado es %i", resultado4);
